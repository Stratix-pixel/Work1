...
public class UserInterface {
		...
		if (check=="found"){ 
				...
				if(Math.signum(number)==-1.0){
					...
					if(theOption2.equals("1")){
						if(CDorMP3=="CDs.txt"){
							...
							Mainclass.shopcart.addItem(CDBought, 1);
							Mainclass.shopcart.addBilling(CDBought, 1);
						}
						else if(CDorMP3=="MP3.txt"){ 
							MP3Bought.changeQuantity(-1);
							changeAudioTextFileContents(MP3Bought);
							Mainclass.shopcart.addItem(MP3Bought, 1);
							Mainclass.shopcart.addBilling(MP3Bought, 1);
						}
						...
						if(CDorMP3=="CDs.txt"){
							...
							changeAudioTextFileContents(CDBought);
							Mainclass.shopcart.addItem(CDBought, number);
							Mainclass.shopcart.addBilling(CDBought, number);
						}
						else if(CDorMP3=="MP3.txt"){ 
							MP3Bought.changeQuantity(-1*number);
							changeAudioTextFileContents(MP3Bought);
							Mainclass.shopcart.addItem(MP3Bought, number);
							Mainclass.shopcart.addBilling(MP3Bought, number);
						}
			...
			while(check2!="found"){
				...
				if(theOption3.equals("-2")){
					...
					System.out.println("");
					Mainclass.bool2=false;
					Mainclass.customer.showBillingInfo();
				}
			} 
		} 
	} 
				...
				if(Math.signum(number)==-1.0){ 
					...
					if(theOption2.equals("1")){ 
						if(bookOrEbook == "Books.txt"){ 
							...
							Mainclass.shopcart.addItem(BookBought, 1);
							Mainclass.shopcart.addBilling(BookBought, 1);
						} 
						else if(bookOrEbook == "Ebooks.txt"){ 
							eBookBought.changeQuantity(-1); 
							changeTextFileContents(eBookBought); 
							Mainclass.shopcart.addItem(eBookBought, 1);
							Mainclass.shopcart.addBilling(eBookBought, 1);
						} 
						...
						if(bookOrEbook == "Books.txt"){ 
							...
							changeTextFileContents(BookBought); 
							Mainclass.shopcart.addItem(BookBought, number);
							Mainclass.shopcart.addBilling(BookBought, number);
						} 
						else if(bookOrEbook == "Ebooks.txt"){ 
							eBookBought.changeQuantity(-1*number);
							changeTextFileContents(eBookBought); 
							Mainclass.shopcart.addItem(eBookBought, number);
							Mainclass.shopcart.addBilling(eBookBought, number);
						} 
	...
	public void showBillingInfo(){
		...
		longestQuantity=0;
		longestPrice=0;
		Mainclass.shopcart.billingArray();
		...
		while(!check4.equals("found")){
			...
			if(choice.equals("yes")){
				...
				System.out.println("Items shipped to: Mr."+Mainclass.nameofuser);
				System.out.println();
				try{
				...
				try {
					addanitem5 = new FileWriter(Mainclass.filename, false);
				...
				try{
					FileWriter addanitem7 = new FileWriter("temp_"+Mainclass.nameofuser+".txt", false);
				...
				try{
					...
					file2.write(Mainclass.nameofuser+",U"+confirmID);
					file2.newLine();
					file2.close();
				}
				catch (IOException e) {
				...
				if ((Integer.toString(ShoppingCart.numValues)!=null)){
					try{
						FileWriter F=new FileWriter("numval_"+Mainclass.nameofuser+".txt",false);
