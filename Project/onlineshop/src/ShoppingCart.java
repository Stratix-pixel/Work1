...
public class ShoppingCart { 
		...
		public void createShoppingCart(){ 
			try{ 
				FileWriter createfile = new FileWriter(Mainclass.filename, true);
		...
		public boolean isempty(){ 
			boolean empty=false; 
			try{ 
				FileReader Fr = new FileReader(Mainclass.filename);
		...
		public void addItem(Item objectadded, int quantity){
			...
			try{
				FileReader user_fr = new FileReader(Mainclass.filename);
			...
			if(checking.equals("found")){ 
				...
				try{ 
					...
					FileWriter clear = new FileWriter(Mainclass.filename, false);
					...
					FileWriter putBack = new FileWriter(Mainclass.filename, true);
			...
			//// if we're appanding a new item to the shopping cart. NOT A REPEAT, NEW /////////
				...
				try{
					FileWriter addanitem = new FileWriter(Mainclass.filename, true);
		...
		public void removeitem(String y){ 
			...
			try{ 
				...
				while (stringRead2!=null){
					...
					if (stringRead2!=null){ 
						...
						if (!temporaryArray[0].equals(y)){ 
							...
							FileReader FR5 = new FileReader("temp_"+Mainclass.nameofuser+".txt");
				...
				FileWriter empty = new FileWriter(Mainclass.filename, false);
				...
				FileWriter addanitem2 = new FileWriter(Mainclass.filename, true);
		...
		public void addBilling(Item objectadded, int quantity){
			...
			try{
				FileReader user_fr = new FileReader("temp_"+Mainclass.nameofuser+".txt");
				BufferedReader user_br = new BufferedReader( user_fr);
				String isItThere = user_br.readLine(); 
				checking1 = "";
				amtTheyHave1 = 0; 
			...
			if(checking.equals("found")){ 
				try{ 
					...
					FileWriter clear = new FileWriter("temp_"+Mainclass.nameofuser+".txt", false);
					BufferedWriter clear1 = new BufferedWriter(clear);
					clear1.write("");
					clear1.close();
					...
					BufferedReader user_BR1 = new BufferedReader(user_FR1);
					FileWriter putBack = new FileWriter("temp_"+Mainclass.nameofuser+".txt", true);
					BufferedWriter putBack1 = new BufferedWriter(putBack); 
					String stringRead3="test"; 
					while (stringRead3!=null){
						stringRead3 = user_BR1.readLine(); 
			...
			//// if not found we say it is not a duplicate so we can just use what is given, no changes required //////
				...
				try{
					FileWriter addanitem = new FileWriter("temp_"+Mainclass.nameofuser+".txt", true);
					BufferedWriter addanitem1 = new BufferedWriter(addanitem);
		...
		public void removeBilling(String ser){
			try{
				FileReader FR = new FileReader("temp_"+Mainclass.nameofuser+".txt");
				BufferedReader BR = new BufferedReader(FR);
				...
				FileWriter empty = new FileWriter("temp_"+Mainclass.nameofuser+".txt", false);
				BufferedWriter empty1 = new BufferedWriter(empty);
				empty1.write("");
				empty1.close();
				...
				BufferedReader BR1 = new BufferedReader(FR1);
				FileWriter addanitem2 = new FileWriter("temp_"+Mainclass.nameofuser+".txt", true);
				BufferedWriter addanitem3 = new BufferedWriter(addanitem2);
